...
export const MOODS = {
  ...
  "Volleyball Gym Sideline": { setting: "indoor volleyball gym sideline with polished wood court and net softly visible in the background", lighting: "bright directional gym lighting", mood: "focused athletic confidence", composition: "athlete portrait with shallow background separation", shot_type: "medium portrait", camera_lens: "85mm portrait lens", weather_atmosphere: "clear and still", color_palette: "warm amber and cream", style_tags: ["sports portrait editorial", "high detail", "depth of field", "clean lineart", "anime realism hybrid", "illustration-grade detailing"] },
  "Volleyball Bleachers": { setting: "indoor volleyball court with bleachers and clean team-media-day structure", lighting: "balanced athletic portrait lighting", mood: "team-media-day confidence", composition: "balanced sports media-day portrait composition", shot_type: "wide full body with environment", camera_lens: "50mm natural lens", weather_atmosphere: "clear and still", color_palette: "cool blue and white", style_tags: ["athlete media day polish", "high detail", "cinematic composition", "soft focus background", "clean lineart", "illustration-grade detailing"] },
  "Volleyball Outdoor Sunset": { setting: "outdoor volleyball court at sunset with warm sand texture and cinematic depth", lighting: "strong golden-hour sports separation", mood: "golden-hour athletic ease", composition: "cinematic golden-hour sports lifestyle portrait", shot_type: "3/4 body shot", camera_lens: "85mm portrait lens", time_of_day: "dusk", weather_atmosphere: "warm lens flare", color_palette: "sunset orange and violet", style_tags: ["sports portrait editorial", "warm color grading", "cinematic composition", "soft bokeh", "anime realism hybrid", "illustration-grade detailing"] },
  "Office Modern Window": { setting: "modern office with large windows and softly blurred city exterior", lighting: "natural window daylight with clean professional falloff", mood: "polished executive confidence", composition: "clean executive portrait composition", shot_type: "medium portrait", camera_lens: "85mm portrait lens", time_of_day: "midday bright", weather_atmosphere: "clear and still", color_palette: "cool blue and white", style_tags: ["business portrait polish", "executive portrait credibility", "soft focus background", "clean lineart", "anime realism hybrid", "illustration-grade detailing"] },
  "Office Desk Workspace": { setting: "refined office desk workspace with laptop, notebook, and subtle work props", lighting: "soft directional office light", mood: "practical professional warmth", composition: "uncluttered desk-side professional portrait", shot_type: "medium portrait", camera_lens: "50mm natural lens", time_of_day: "late afternoon", weather_atmosphere: "clear and still", color_palette: "warm amber and cream", style_tags: ["business portrait polish", "corporate lifestyle portrait", "high detail", "soft bokeh", "clean lineart", "illustration-grade detailing"] },
  "Office Conference Room": { setting: "modern conference room with glass walls and clean architectural lines", lighting: "neutral professional conference lighting", mood: "credible leadership presence", composition: "architectural leadership portrait composition", shot_type: "medium portrait", camera_lens: "50mm natural lens", time_of_day: "midday bright", weather_atmosphere: "overcast diffused", color_palette: "deep navy and gold", style_tags: ["executive portrait credibility", "business portrait polish", "cinematic composition", "clean lineart", "anime realism hybrid", "illustration-grade detailing"] },
...
export const generatePrompt = (overrides = {}) => ({
  ...
  negative_tags: overrides.negative_tags ?? DATA.negative_tags,
});

export const buildPromptString = (prompt) =>
  `${prompt.aspect_ratio}, ${prompt.orientation} orientation, ${prompt.shot_type}, ${prompt.composition}, ${prompt.camera_lens}, ${prompt.color_palette} color palette, ${prompt.time_of_day}, ${prompt.weather_atmosphere}, ${prompt.anime_render_style}, ${prompt.linework_style}, ${prompt.shading_style}, ${prompt.anime_eye_render}, ${prompt.body_type} body type, ${prompt.age_aesthetic}, ${prompt.expression}, ${prompt.makeup}, ${prompt.hair_color} hair, ${prompt.hair_length}, ${prompt.hair_style}, ${prompt.eye_color} eyes, ${prompt.eye_style}, ${prompt.face_shape}, ${prompt.nose}, ${prompt.lips}, ${prompt.skin_tone} skin, ${prompt.blush}, ${prompt.accessories}, wearing ${prompt.outfit}, ${prompt.pose}, ${prompt.setting}, ${prompt.lighting}, ${prompt.mood} mood, ${prompt.style_tags.join(", ")}`;
